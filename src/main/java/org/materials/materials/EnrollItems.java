...
public class EnrollItems
{
    ...
    // 注册名为 体质强化饮料 的物品
    public static final RegistryObject<Item> PHYSIQUE_STRENGTHENING_BEVERAGE_ITEM = ITEMS.register("physique_strengthening_beverage", () ->
    ...
    {
        event.enqueueWork(EnrollItems::registerBrewingRecipes);
    }
}
